...
control 'osw files' do
  ...
  files += [
    ...
    %w[/etc/php/8.2/fpm/php.ini                                         root                  root                  0644],
    %w[/etc/php/8.2/fpm/php-fpm.conf                                    root                  root                  0644],
    %w[/etc/php/8.2/fpm/pool.d/opensourcewebsite.org.conf               root                  root                  0644],
    %w[/etc/php/8.2/fpm/pool.d/www.conf                                 root                  root                  0644],
    %w[/etc/php/8.2/cli/php.ini                                         root                  root                  0644],
    ...
    %w[/etc/logrotate.d/php8.2-fpm                                      root                  root                  0644],
